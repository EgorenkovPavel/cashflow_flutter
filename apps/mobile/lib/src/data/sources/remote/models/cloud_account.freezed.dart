...
mixin _$CloudAccount {
 ...
 String get id; String get title; bool get isDebt; bool get deleted; String get user;
...
@override
int get hashCode => Object.hash(runtimeType,id,title,isDebt,deleted,user);
...
@useResult
$Res call({
 String id, String title, bool isDebt, bool deleted, String user
});
...
/// Create a copy of CloudAccount
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? isDebt = null,Object? deleted = null,Object? user = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  bool isDebt,  bool deleted,  String user)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CloudAccount() when $default != null:
return $default(_that.id,_that.title,_that.isDebt,_that.deleted,_that.user);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title,  bool isDebt,  bool deleted,  String user)  $default,) {final _that = this;
switch (_that) {
case _CloudAccount():
return $default(_that.id,_that.title,_that.isDebt,_that.deleted,_that.user);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String title,  bool isDebt,  bool deleted,  String user)?  $default,) {final _that = this;
switch (_that) {
case _CloudAccount() when $default != null:
return $default(_that.id,_that.title,_that.isDebt,_that.deleted,_that.user);case _:
  return null;
...
class _CloudAccount implements CloudAccount {
  const _CloudAccount({required this.id, required this.title, required this.isDebt, required this.deleted, required this.user});
...
/// Create a copy of CloudAccount
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? isDebt = null,Object? deleted = null,Object? user = null,}) {
