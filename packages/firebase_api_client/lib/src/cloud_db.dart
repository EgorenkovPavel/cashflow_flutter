...
import 'package:firebase_api_client/src/table_dao.dart';
...
class CloudDb {
  ...
  static Future<bool> databaseExists(FirebaseFirestore firestore, CloudUser user) async {
  ...
  Future<void> addUserToDatabase(CloudUser user) async {
